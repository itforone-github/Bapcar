...
import com.itforone.bapcar.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstUrl+="?deviceId="+Common.getMyDeviceId(MainActivity.this);
        ...
        try{
            if(!intent.getExtras().getString("goUrl").equals("")&&!intent.getExtras().getString("goUrl").equals(null)){
                ...
                if(0 < intent.getExtras().getString("goUrl").indexOf("?")){
                    firstUrl=intent.getExtras().getString("goUrl")+"&subject="+subject;
                }else{
                    firstUrl=intent.getExtras().getString("goUrl")+"?subject="+subject;
                }
                Log.d("url",firstUrl);
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("bapcar");
        //토큰생성
        refreshToken();
        //위치 잡기
...
//                    filePathCallbackLollipop.onReceiveValue(null);
    ...
    WebViewClient client;
    {
        client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                Log.d("end-with",url.endsWith("php")+"");
                //파일 다운로드
                if((url.indexOf("php") < 0)){
                    ...
                    dm.enqueue(request);
                    /*Intent intent = new Intent(MainActivity.this,DownLoadWebViewActivity.class);
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if(isIndex==false) {
                    ...
                    //버전체크 하기
                    binding.webView.loadUrl("javascript:versionCheck('"+Common.getVersion(MainActivity.this)+"','"+Common.getMyDeviceId(MainActivity.this)+"')");
                }
    ...
    class WebJavascriptEvent{
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(LocationPosition.lat == 0.0){
                        ...
                        //LocationFind();
                        //Toast.makeText(MainActivity.this, "다시 한번 현재위치 설정을 누르시면 됩니다.", Toast.LENGTH_SHORT).show();
                    }else {
                        String address=LocationPosition.getAddress(LocationPosition.lat,LocationPosition.lng);
                        binding.webView.loadUrl("javascript:getAddress('"+address+"','"+LocationPosition.lat+"','"+LocationPosition.lng+"')");
                    }
        ...
        @JavascriptInterface
        public void loadingPosition(String msg){
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    binding.progressLayout.setVisibility(View.VISIBLE);
                    binding.msgTextView.setText(msg);
                    Glide.with(MainActivity.this)
                            .load(R.raw.loading)
                            .override(350,150)
                            .into(binding.progressImageView);
        ...
        @JavascriptInterface
        public void positionLoading(String msg){
            binding.progressLayout.setVisibility(View.VISIBLE);
    ...
    Handler mHandler = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if(msg.what == 0){
                ...
                //Toast.makeText(MainActivity.this, "위치잡기", Toast.LENGTH_SHORT).show();
                LocationFind();
                getAddress();
            }
        }
    ...
    private void postFile(List<? extends Uri>  uri){
        ...
        for(int i =0 ; i< mSelected.size();i++ ){
            ...
            if(0 <= mSelected.get(i).toString().indexOf("file://")) {
                try {
                    inputStream = MainActivity.this.getContentResolver().openInputStream(mSelected.get(i));
                    //이미지파일을 비트맵으로 만들기
                ...
                RealPath rp = new RealPath(MainActivity.this,mSelected.get(i));
            ...
            /*RealPath rp = new RealPath(MainActivity.this,mSelected.get(i));//절대경로 찾아내기
