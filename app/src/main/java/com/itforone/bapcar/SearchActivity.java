...
import com.itforone.bapcar.databinding.ActivitySearchBinding;
...
public class SearchActivity extends AppCompatActivity {
    ...
    final private String SEARCH_URL="https://www.yoonfoodsystem.co.kr/bbs/app_search.php";
        ...
        client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if((0 < url.indexOf("download.php") )){
                    ...
                    dm.enqueue(request);
                    /*Intent intent = new Intent(SearchActivity.this,DownLoadWebViewActivity.class);
