...
import com.itforone.bapcar.databinding.ActivityAroundStoreBinding;
...
public class AroundStoreActivity extends AppCompatActivity {
    ActivityAroundStoreBinding binding;
    ...
    String firstUrl = "https://www.yoonfoodsystem.co.kr/bbs/food_list.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ss_mb_id = Common.getPref(AroundStoreActivity.this,"ss_mb_id","");


        binding = DataBindingUtil.setContentView(this,R.layout.activity_around_store);
        binding.setAroundStore(this);
        ...
        Log.d("ss_mb_id",Common.getPref(AroundStoreActivity.this,"ss_mb_id",""));





        //Toast.makeText(AroundStoreActivity.this, binding.w, Toast.LENGTH_SHORT).show();
    ...
    WebChromeClient chrome;
    {
        chrome = new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
                new AlertDialog.Builder(AroundStoreActivity.this)
                        .setMessage("\n" + message + "\n")
                        .setCancelable(false)
            ...
            public void onGeolocationPermissionsShowPrompt(String origin, GeolocationPermissions.Callback callback) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AroundStoreActivity.this);
            ...
            public boolean onShowFileChooser(
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {// API 24 이상 일경우..
                    File imageStorageDir = new File(AroundStoreActivity.this.getFilesDir() + "/Pictures", "bapcar_phto");
                    ...
                    Uri providerURI = FileProvider.getUriForFile(AroundStoreActivity.this, AroundStoreActivity.this.getPackageName() + ".provider", file);
...
//                    filePathCallbackLollipop.onReceiveValue(null);
    ...
    WebViewClient client;
    {
        client = new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                /*Glide.with(AroundStoreActivity.this)
                        .load(R.raw.progress)
                ...
                if((0 < url.indexOf("download.php") )){
                    ...
                    dm.enqueue(request);
                    /*Intent intent = new Intent(AroundStoreActivity.this,DownLoadWebViewActivity.class);
                ...
                /*if (0 < url.indexOf("view.php") ||
                    ...
                    Intent intent = new Intent(AroundStoreActivity.this,WebActivity.class);
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if(isIndex==false) {
                    ...
                    //버전체크 하기
                    binding.webView.loadUrl("javascript:versionCheck('"+Common.getVersion(AroundStoreActivity.this)+"','"+Common.getMyDeviceId(AroundStoreActivity.this)+"')");
                }
                ...
                try{
                    if(!Common.TOKEN.equals("")){
                        view.loadUrl("javascript:fcmKey('"+Common.TOKEN+"','"+Common.getMyDeviceId(AroundStoreActivity.this)+"')");
                    }
                }catch (Exception e){
                    //토큰 생성
                    refreshToken();
    ...
    private void LocationFind(){
        LocationPosition.act=AroundStoreActivity.this;
        LocationPosition.setPosition(AroundStoreActivity.this);
    ...
    class WebJavascriptEvent{
        ...
        public void getMessage(String message){
            Toast.makeText(AroundStoreActivity.this, message, Toast.LENGTH_SHORT).show();
        }
        @JavascriptInterface
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    if(LocationPosition.lat == 0.0){
                        ...
                        //LocationFind();
                        //Toast.makeText(AroundStoreActivity.this, "다시 한번 현재위치 설정을 누르시면 됩니다.", Toast.LENGTH_SHORT).show();
                    }else {
                        String address=LocationPosition.getAddress(LocationPosition.lat,LocationPosition.lng);
                        binding.webView.loadUrl("javascript:getAddress('"+address+"','"+LocationPosition.lat+"','"+LocationPosition.lng+"')");
                    }
        ...
        public void matisse(String number){
           /* int num=Integer.parseInt(number);
            Matisse.from(AroundStoreActivity.this)
            ...
            TedImagePicker.with(AroundStoreActivity.this)
        ...
        FirebaseMessaging.getInstance().getToken()
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        ...
                        // Toast.makeText(AroundStoreActivity.this, msg, Toast.LENGTH_SHORT).show();
                    }
    ...
    Handler mHandler = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if(msg.what == 0){
                ...
                //Toast.makeText(AroundStoreActivity.this, "위치잡기", Toast.LENGTH_SHORT).show();
                LocationFind();
                getAddress();
            }
        }
    ...
    private void postFile(List<? extends Uri>  uri){
        ...
        for(int i =0 ; i< mSelected.size();i++ ){
            ...
            if(0 <= mSelected.get(i).toString().indexOf("file://")) {
                try {
                    inputStream = AroundStoreActivity.this.getContentResolver().openInputStream(mSelected.get(i));
                    //이미지파일을 비트맵으로 만들기
                ...
                RealPath rp = new RealPath(AroundStoreActivity.this,mSelected.get(i));
            ...
            /*RealPath rp = new RealPath(AroundStoreActivity.this,mSelected.get(i));//절대경로 찾아내기
        ...
        public void onClick(View v) {
            ...
            switch(v.getId()){
                ...
                case R.id.btnLayout3:
                    binding.webView.loadUrl(getString(R.string.url)+"/bbs/food_list.php");
                    break;
                //마이페이지
